...
export function OrderFormContent({ products }: OrderFormContentProps) {
        ...
        {product ? (
          <div className="flex gap-8 mb-10">
            ...
            <div className="flex flex-col justify-center">
              <span className="text-brand-secondary/30 text-[10px] font-bold uppercase tracking-widest mb-1">{product.category}</span>
