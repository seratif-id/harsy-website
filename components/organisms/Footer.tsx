        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-12 border-b border-white/10 pb-12">
          <div>
            ...
            <p className="text-white/70 max-w-xs leading-relaxed">
              Mewujudkan imajinasi menjadi rajutan tangan yang penuh cinta dan kehangatan untuk Anda dan si buah hati.
            </p>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              <li><Link href="/" className="hover:text-brand-secondary transition-colors">Beranda</Link></li>
              <li><Link href="/products" className="hover:text-brand-secondary transition-colors">Koleksi Produk</Link></li>
              <li><Link href="/order" className="hover:text-brand-secondary transition-colors">Cara Pesan</Link></li>
            </ul>
          </div>
          ...
          <div>
            ...
            <ul className="space-y-4 text-white/70">
              <li className="flex items-start gap-3">
                ...
                <span>Jl. Mekarwangi No. 21 <br/> Kabupaten Bandung Barat <br/> Jawa Barat 40559</span>
              </li>
              <li className="flex items-center gap-3">
                ...
                <span>harsy.handmade@gmail.com</span>
              </li>
              <li className="flex items-center gap-3">
